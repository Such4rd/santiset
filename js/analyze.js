...
let ui = {server:'J1', serve_number:'1º', rally:'MENOS_3', highlight:0, category:'SAQUE', mode:'ADVANTAGE', seconds:0, running:false, timer:null, score:initialScore()};
...
function registerPoint(data, sourceButton=null){
  ...
  pulse(sourceButton); addPoint(point); ui.score=nextScore; ui.serve_number='1º'; ui.highlight=0; render();
}
...
function resetRuntime(){ ui.score=initialScore(); ui.seconds=0; ui.highlight=0; ui.serve_number='1º'; ui.rally='MENOS_3'; }
...
document.addEventListener('click',async event=>{
  ...
  if(target.dataset.act==='server'){ ui.server={J1:'J2',J2:'R1',R1:'R2',R2:'J1'}[ui.server]; render(); }
